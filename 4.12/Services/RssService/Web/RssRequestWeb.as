package
{
	...
	public class RssRequestWeb extends RssRequest
	{
		private var m_rssWebService:WebService = new WebService();
		
		public function RssRequestWeb(i_masterServerUrl:String, i_rssMap:Object, i_url:String, i_minValidTime:Number, i_maxValidTime:Number)
		{
